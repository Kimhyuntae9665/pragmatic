...
// grid는 e로딩이 완료되었는데 img만 나중에 로딩이 되니까 img가 layout이 되지 않고 어정쩡하게 있는것 ==> img로딩을 한번 더 해준다
// img까지 모두 로드 되었을 때 magicgrid를 다시 positioning 하라 ==> img 가 모두 로딩 되었으니 img에 맞게 magicgrid 를 포지셔닝 하라
